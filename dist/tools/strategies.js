...
export function registerStrategyTools(server, client) {
    ...
    server.tool('dwlf_describe_strategy_nodes', 'Describe the visual-strategy node types and their (currently-implicit) runtime parameters. ' +
    ...
    // 6. Delete strategy
    server.tool('dwlf_delete_strategy', "Permanently delete a visual strategy. Hard delete — also removes the compiled executable and symbol activations. " +
