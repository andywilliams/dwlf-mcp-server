...
export function registerWatchlistTools(
  ...
  server.tool(
    ...
    "Get the user's BRIEFING LIST — symbols they want in the daily briefing but are NOT " +
      ...
      '(dwlf_get_cycle_setups); the briefing list is the curated middle tier.',
    {},
    async () => {
      try {
  ...
  server.tool(
    ...
    "Remove a symbol from the user's briefing list.",
    {
      symbol: z
        .string()
